...
class ClientModelAdmin(admin.ModelAdmin):
    ...
    list_display_links = ['first_name', 'last_name', 'passport']
...
class RoomModelAdmin(admin.ModelAdmin):
    ...
    list_display_links = ['room_number', 'type', 'category', 'cost_per_day']
...
class ReservationModelAdmin(admin.ModelAdmin):
    ...
    list_display_links = ['reservation_date', 'checkin_date', 'checkout_date', 'room', 'client']
